...
/*
 * Metodo para abrir o "modal-data" para cadastrar ou editar um contato
 */
function getModalData(contact) {
    $('#md-edit, #md-new').attr({
        'data-toggle': 'modal',
    ...
    if (contact === null) {
        ...
        $('#btn-md-save').attr('onclick', 'saveNew()');
    } else {
        $('#btn-md-save').attr('onclick', 'updateContact(' + contact + ')');
    }
}
