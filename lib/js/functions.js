...
function load() {
    ...
    if (localStorage.length == 0) {
        lstContacts = [
            { 'id': '534', 'nome': 'Marcos Vinicius', 'email': 'marcos@forlogic.net', 'telefone': '(43) 9927-8871', 'sexo': '1', 'endereco': 'Rua 23, nº 8', 'obs': '', 'fav': '1' },
            ...
            { 'id': '2', 'nome': 'Yudi', 'email': 'yudi@bomdiaecia.com.br', 'telefone': '(11) 4002-8922', 'sexo': '1', 'endereco': 'Bom dia e Cia', 'obs': 'Playstation Playstation Playstation Playstation Playstation', 'fav': '1' }
        ];
    } else {
...
function addToTable(contact) {
    ...
    cols += '<a onclick="removeContact(this,' + contact['id'] + ')" title="Excluir"><i class="fa fa-trash-o"></i></a>';
    cols += '<a onclick="view(' + contact['id'] + ')" title="Visualizar" id="btnView" data-toggle="modal" data-target="#modal-view"><i class="' + (contact['obs'] == '' ? 'fa fa-file-text-o' : 'fa fa-file-text') + '"></i></a>';
